			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-4 text-center text-md-right">
					<?php if ( get_theme_mod('green_farm_elementor_header_location') ) : ?>
						<p class="mb-0"><?php echo esc_html( get_theme_mod('green_farm_elementor_header_location' ) ); ?></p>
					<?php endif; ?>
				</div>
				<div class="col-lg-3 col-md-4 col-sm-4 text-center text-md-right">
					<?php if ( get_theme_mod('green_farm_elementor_header_email') ) : ?>
						<p class="mb-0"><?php echo esc_html( get_theme_mod('green_farm_elementor_header_email' ) ); ?></p>
					<?php endif; ?>
				</div>
			</div>
		</div>
							...
							<div class="social-links text-center text-md-right">
								<?php if ( is_array($green_farm_elementor_settings) || is_object($green_farm_elementor_settings) ){ ?>
							    	<?php foreach( $green_farm_elementor_settings as $green_farm_elementor_setting ) { ?>
								        <a href="<?php echo esc_url( $green_farm_elementor_setting['link_url'] ); ?>">
							...
							<?php if ( get_theme_mod('green_farm_elementor_header_phone_number') || get_theme_mod('green_farm_elementor_header_phone_number_text') ) : ?>
								<div class="row header-icon">
									...
									<div class="col-lg-9 col-md-9 col-sm-9 col-9 align-self-center">
										...
										<h6 class="mb-0"><?php echo esc_html( get_theme_mod('green_farm_elementor_header_phone_number' ) ); ?></h6>
									</div>
								</div>
							<?php endif; ?>
						</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-2 col-sm-6 px-md-0 align-self-center">
						...
						<?php if ( class_exists( 'woocommerce' ) ) {?>
							<a class="cart-customlocation" href="<?php if(function_exists('wc_get_cart_url')){ echo esc_url(wc_get_cart_url()); } ?>" title="<?php esc_attr_e( 'View Shopping Cart','green-farm-elementor' ); ?>"><i class="fas fa-shopping-basket mr-2"></i><span class="cart-item-box">( <?php echo esc_html(wp_kses_data( WC()->cart->get_cart_contents_count() ));?> )</span></a>
						<?php }?>
					</div>
			   	</div>
			</div>

...
if (!function_exists('green_farm_elementor_after_setup_theme')) {
	...
	function green_farm_elementor_after_setup_theme() {
		...
		if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'green-farm-elementor') {
			wp_redirect(admin_url('themes.php?page=green_farm_elementor_about'));
...
function green_farm_elementor_logo_resizer() {
    ...
    $green_farm_elementor_logo_resizer = get_theme_mod('green_farm_elementor_logo_resizer');

	$green_farm_elementor_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($green_farm_elementor_logo_resizer).'px !important;
			width: '.esc_attr($green_farm_elementor_logo_resizer).'px !important;
		}
	';
...
define('GREEN_FARM_ELEMENTOR_FREE_THEME_DOC',__('https://www.wpelemento.com/theme-documentation/elementor-green-farm/','green-farm-elementor'));
...
define('GREEN_FARM_ELEMENTOR_BUY_NOW',__('https://www.wpelemento.com/elementor/green-farm-wordpress-theme/','green-farm-elementor'));
define('GREEN_FARM_ELEMENTOR_LIVE_DEMO',__('https://www.wpelemento.com/demo/elementor-green-farm/','green-farm-elementor'));
define('GREEN_FARM_ELEMENTOR_THEME_BUNDLE',__('https://www.wpelemento.com/elementor/wordpress-theme-bundle/','green-farm-elementor'));

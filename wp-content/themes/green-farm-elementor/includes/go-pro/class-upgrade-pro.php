		...
		$manager->add_section(
			new Green_Farm_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_text'    => esc_html__( 'GO PRO', 'green-farm-elementor' ),
					'pro_url'     => 'https://www.wpelemento.com/elementor/green-farm-wordpress-theme/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Green_Farm_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/theme-documentation/elementor-green-farm/',
					'priority'    => 5,
				)
			)
		);
		...
		$manager->add_section(
			new Green_Farm_Elementor_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'     => 'https://www.wpelemento.com/demo/elementor-green-farm/',
					'priority'    => 5,
				)
			)
		);
